...
def render(tab, analog_sel, state_sel, scen_sel, sort_sel,
    ...
    if tab == 'tab-full':
        ...
        COT_RISK = [
            {'cat':'Managed Money Net','pctile':12,'value':-33546,'signal':'EXTREME SHORT','risk':'Contrarian bull — max short-covering fuel. 72% hit rate at 1Y when MM ≤5th pctile.','col':P['red']},
            {'cat':'MM Gross Short',   'pctile':99,'value':74951,'signal':'RECORD SHORT','risk':'74,951 contracts short — near 20yr highs. Any bullish catalyst triggers cascade cover.','col':P['red']},
            ...
            {'cat':'Other Reportable', 'pctile':100,'value':56063,'signal':'RECORD LONG','risk':'Index/pension at all-time high allocation. Structural support but watch for rebalancing.','col':P['amber']},
            {'cat':'Producer Hedge',   'pctile':59,'value':-66930,'signal':'NEUTRAL HEDGE','risk':'Producer hedging near average — typical positioning for this time of year.','col':P['teal']},
        ]
