                ...
                html.Div(style={'display':'flex','gap':'16px','flexWrap':'wrap','alignItems':'flex-end'}, children=[
                    html.Div([
                        ...
                        dcc.Input(id='ov-cotton', type='number', placeholder='e.g. 73.58',
                                  ...
                                  style={'width':'110px','background':P['bg'],'color':P['amber'],
                                         'border':f'1px solid {P["amber"]}','borderRadius':'4px',
                                         'padding':'6px 8px','fontFamily':'Courier New',
