...
WOW_CHANGES = {
    ...
    'Silver': {'mm_net':8168,'mm_long':25026,'mm_short':16858},
    'Gold': {'mm_net':-4571,'mm_long':5366,'mm_short':9937},
    'Lean Hogs': {'mm_net':-58810,'mm_long':-51564,'mm_short':7246},
    'Live Cattle': {'mm_net':-26414,'mm_long':-30763,'mm_short':-4349},
    'SRW Wheat': {'mm_net':18557,'mm_long':-17890,'mm_short':-36447},
    'HRW Wheat': {'mm_net':13093,'mm_long':-34761,'mm_short':-47854},
    ...
    'Soy Meal': {'mm_net':-54399,'mm_long':-53989,'mm_short':410},
...
def render(tab, analog_sel, state_sel, scen_sel, sort_sel,
    ...
    if tab == 'tab-full':
        ...
        COT_RISK = [
            {'cat':'Managed Money Net','pctile':24,'value':7810,'signal':'SHORT','risk':'Contrarian bull — max short-covering fuel. 72% hit rate at 1Y when MM ≤5th pctile.','col':P['red']},
            {'cat':'MM Gross Short',   'pctile':94,'value':39825,'signal':'ELEVATED SHORT','risk':'39,825 contracts short — near 20yr highs. Any bullish catalyst triggers cascade cover.','col':P['red']},
            {'cat':'MM Gross Long',    'pctile':56,'value':47635,'signal':'NEUTRAL','risk':'Longs not crowded. Room for significant new long accumulation on price rally.','col':P['muted']},
            {'cat':'Producer Hedge',   'pctile':59,'value':0,'signal':'NEUTRAL HEDGE','risk':'Producer hedging near average — typical positioning for this time of year.','col':P['teal']},
        ]
        ...
        live_row = html.Div([
            ...
            price_kpi('Cotton D2+',   '46%',           '',     'USDA DM · Jan 06 2015',   P['red']),
            price_kpi('MM Net Short', '99th pctile',   '',     'CFTC COT · Jan 06 2015',  P['red']),
        ], style={'display':'flex','gap':'10px','flexWrap':'wrap','marginBottom':'16px'})
        ...
        cot_risk_tbl = html.Div([
            sh('COT Positioning Risk Analysis — Jan 06, 2015'),
