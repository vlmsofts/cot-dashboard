...
# Merge: file data takes priority, embedded fills in missing markets
    ...
    fig.update_layout(
        ...
        annotations=[
            dict(x=COT_COMMODITIES[ci], y=COT_CAT_LABELS[COT_CATS[ri]],
                 ...
                 font=dict(size=11, color='white', family='Courier New, monospace'), bgcolor='rgba(0,0,0,0.25)', borderpad=1)
